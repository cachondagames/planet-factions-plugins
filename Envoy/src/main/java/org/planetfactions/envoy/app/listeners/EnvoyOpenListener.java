				...
				try 
				{
					...
					for(Block b : blocks) // Checks if the block that was right clicked was one placed by envoy create
					{
						if(e.getClickedBlock().equals(b))
						{
							try
							{
								if(e.getClickedBlock().getType().equals(Material.getMaterial(envoy.getPlugin().getConfig().getString("Prizes.basic.Block").toUpperCase()))) // Checks for tiers as below
								{
							...
							try
							{
								if(e.getClickedBlock().getType().equals(Material.getMaterial(envoy.getPlugin().getConfig().getString("Prizes.standard.Block").toUpperCase())))
								{
							...
							try
							{
								if(e.getClickedBlock().getType().equals(Material.getMaterial(envoy.getPlugin().getConfig().getString("Prizes.advanced.Block").toUpperCase())))
								{
